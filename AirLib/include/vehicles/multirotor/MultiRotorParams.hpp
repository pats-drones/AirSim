...
protected: //static utility functions for derived classes to use
    ...
    void setupFrameGenericQuad(Params& params)
    {
        ...
        real_T motor_assembly_weight = 0.0022f;  //weight for motor used in the Hammer drone
        ...
        //set up dimensions of core body box of the Hammer
        params.body_box.x() = 0.010f; params.body_box.y() = 0.010f; params.body_box.z() = 0.0040f;
